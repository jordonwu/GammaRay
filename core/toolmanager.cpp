...
void GammaRay::ToolManager::selectTool(const QString &toolId)
{
...
GammaRay::ToolInfo GammaRay::ToolManager::toolInfoForFactory(GammaRay::ToolFactory *factory) const
{
    ToolInfo info;
    info.id = factory->id();
...
bool GammaRay::ToolManager::hasTool(const QString &id) const
{
    foreach (ToolFactory *factory, m_tools) {
        if (factory->id() == id)
            return true;
...
void GammaRay::ToolManager::objectAdded(QObject *obj)
{
...
void GammaRay::ToolManager::objectAdded(const QMetaObject *mo)
{
...
ToolPluginManager *GammaRay::ToolManager::toolPluginManager() const
{
